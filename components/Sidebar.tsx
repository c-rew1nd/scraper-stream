"use client"
import { CoinsIcon, HomeIcon, Icon, Layers2Icon, MenuIcon, ShieldCheckIcon } from 'lucide-react'
...
export function MobileSidebar() {
  ...
  return <div className="block block-separate bg-background md:hidden">
